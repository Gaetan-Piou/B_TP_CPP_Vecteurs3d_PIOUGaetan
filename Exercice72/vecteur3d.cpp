...
CVecteur3d CVecteur3d::sommeVecteurs(CVecteur3d vect) {
	//BUT: Faire la somme de deux vecteurs
	//ENTREE: Un autre vecteur
	//SORTIE: La somme des deux vecteurs

	CVecteur3d vectSomme(this->getX() + vect.getX(), this->getY() + vect.getY(), this->getZ() + vect.getZ());
	return vectSomme;
}


float CVecteur3d::scalaireVecteurs(CVecteur3d vect) {
	//BUT: Faire le produit scalaire de deux vecteurs
	//ENTREE: Un autre vecteur
	//SORTIE: Le produit scalaire des deux vecteurs

	float produitScalaire = this->getX() * vect.getX() + this->getY() * vect.getY() + this->getZ() * vect.getZ();
